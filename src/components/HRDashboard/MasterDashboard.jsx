    ...
    return (
        <Container fluid className="p-4">
          ...
          <Row className="d-flex align-items-center justify-content-center">
                {/* Heading should be inside a Col for proper grid alignment */}
                <Col xs={12}>
                ...
                {companies.map((company, idx) => (
                    <Col
                        ...
                        md={6}          // Two cards per row on medium devices
                        lg={4}          // Three cards per row on large devices
                        xl={3}          // Four cards per row on extra-large
                        className="d-flex justify-content-center mb-4"
                    >
                        <div
                            className="shadow-sm bg-white w-100 mx-auto"
                            style={{
                                maxWidth: '300px',
                                borderRadius: '20px',
                                padding: '20px',
                        ...
                        >
                            ...
                            <div className="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                                ...
                                />
                                <h6 className="mb-0 fw-semibold ms-2 flex-grow-1 fontclr text-truncate">
                                    {company.name}
                                </h6>
                                <span
                                    className="badge text-white fw-semibold mt-2 mt-md-0"
                                    style={{
                                        fontSize: "0.75rem",
                                        padding: "6px 12px",
