            ...
            <Row className="mb-4" style={{ minHeight: '360px' }}>
                <Col md={7}>
                    <div className="shadow-sm border-0 p-3 rounded bg-white mb-3" style={{ height: '400px' }}>
                        <div className="profile-header-bar d-flex justify-content-between align-items-center mb-3">
                ...
                <Col md={5}>
                    <div className="bg-white p-3 rounded shadow-sm" style={{ height: '400px' }}>
                        <h6 className="fw-bold mb-3 text-start text424242 notifi">Notifications</h6>
                ...
                <Row xs={1} md={2} className="g-3">
                    {jobs.map((job, idx) => (
                        <Col key={idx} className="d-flex">
                            <div className="border rounded-4 shadow-sm p-3 flex-grow-1 d-flex flex-column" style={{ minHeight: '150px' }}>

                                {/* Stack logo and content vertically */}
                                <div className="d-flex flex-column align-items-center text-center text-md-start flex-md-row">

                                    {/* Logo on top for small screens, left for md+ */}
                                    ...
                                    <div className="flex-grow-1 d-flex flex-column">
                                        <div className="d-flex justify-content-between flex-column flex-md-row align-items-center align-items-md-start">
                                            <h6 className="mb-1 fw-bold text424242">{job.title}</h6>
                                            <BsBookmark size={18} className="text-muted mt-1" />
                                        </div>

                                        <div className="text-muted small d-flex flex-wrap align-items-center gap-3 mb-2 justify-content-center justify-content-md-start">
                                        ...
                                        <div className="fw-semibold text-dark mb-3 d-flex align-items-center gap-1 justify-content-center justify-content-md-start text424242">
                                            <FaRupeeSign size={18} /> {job.salary}
                                        </div>

                                        {/* Tags */}
                                        <div className="d-flex flex-wrap gap-2 mt-auto justify-content-center justify-content-md-start">
                                            {job.tags.map((tag, i) => {
