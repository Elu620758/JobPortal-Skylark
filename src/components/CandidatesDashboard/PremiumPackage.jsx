            ...
            <Row className="mb-5">
                <Col xs={12} md={6}>
                    <div className="mb-4 text-center text-md-start">
                        <h6 className="fw-bold text-primary">Choose Your Plan</h6>
                        <h2 className="fw-bold fs-1">Save up to 10%</h2>
                        <ToggleButtonGroup
                            type="radio"
                            name="planType"
                            defaultValue={1}
                            className="mt-3 d-flex justify-content-center justify-content-md-start flex-wrap gap-3"
                        >
                            <ToggleButton
                                id="monthly"
                                value={1}
                                className="fw-semibold custom-toggle-pp rounded-pill min-w-0"
                            >
                                Monthly
                            </ToggleButton>
                            <ToggleButton
