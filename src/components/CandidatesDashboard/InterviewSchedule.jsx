            ...
            <Row>
                ...
                <Col xs={12} md={4} lg={3} className="bg-light p-3">
                    ...
                    <div className="interview-card p-3 mb-3 shadow-sm rounded">
                        ...
                        <div className="d-flex flex-column flex-sm-row align-items-center justify-content-between mb-2 gap-2">
                            {/* Image + Info */}
                            <div className="d-flex flex-column flex-sm-row align-items-center text-center text-sm-start">
                                ...
                                <div className='ms-sm-3 mt-2 mt-sm-0'>
                                    <div className="fw-semibold fontclr">Fiesta</div>
                                    <small className="text-muted fontclr">Web Developer</small>
                                </div>
                            </div>

                            {/* Time Badge */}
                            <Badge className="time-badge px-2 mt-2 mt-sm-0">Tdy, 3PM</Badge>
                        </div>

                        {/* Location and CTC */}
                        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-sm-start gap-2 mb-2 text-center text-sm-start">
                    ...
                    <div className="interview-card p-3 mb-3 shadow-sm rounded">
                        <div className="d-flex flex-column flex-sm-row align-items-center justify-content-between gap-2">
                            ...
                            <div className="d-flex flex-column flex-sm-row align-items-center text-center text-sm-start">
                                ...
                                />
                                <div className="ms-sm-3 mt-2 mt-sm-0">
                                    <div className="fw-semibold fontclr">Acid India</div>
                                    <small className="text-muted fontclr">Web Developer</small>
                                </div>
                            </div>

                            {/* Right: Badge */}
                            <Badge bg="primary" className="time-badge text-center mt-2 mt-sm-0">
                                8th May 25<br />4PM
                            </Badge>
                        </div>
                    </div>
                ...
                <Col xs={12} lg={8}>
                    <Row className="align-items-center justify-content-between mb-5">
                        {/* Heading: Full width on mobile, left on larger */}
                        <Col xs={12} sm="auto" className="text-center text-sm-start mb-2 mb-sm-0">
                            <h6 className="fw-bold fontclr mb-0">May 4th - 10th, 2025</h6>
                        </Col>

                        {/* Dropdown: Full width on mobile, right-aligned on larger */}
                        <Col xs={12} sm="auto">
                            <div className="d-flex justify-content-center justify-content-sm-end">
                                <Dropdown className="w-100 w-sm-auto">
                                    ...
                                    >
                                        <span className="textColor-applied fontclr">Week</span>
